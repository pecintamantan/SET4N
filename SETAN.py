    ...
    try:
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://www.youtube.com/channel/UCyZpRlHeVnu002b2FKJ7Kqg')
                time.sleep(2)
                menu()
